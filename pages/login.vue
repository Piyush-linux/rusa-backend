...
//   try {
//     let data = await login({ identifier: email.value , password: password.value })
//     console.log(data)
//     router.push('/')
//   } catch (e) {}
// }
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-lg">
                ...
                <div class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                    ...
                    <!-- Submit -->
                    <button  @click="submit" class="block w-full rounded-lg bg-indigo-600 px-5 py-3 text-sm font-medium text-white">
                        Sign in
                    </button>
